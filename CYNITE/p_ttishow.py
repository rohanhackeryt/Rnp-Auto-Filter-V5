...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('ʀᴇᴘᴏʀᴛ ʜᴇʀᴇ', url=f"https://t.me/MrRnp")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
        ...
        if settings["welcome"]:
            for u in message.new_chat_members:
                buttons = [[
                InlineKeyboardButton("ɢʀᴏᴜᴘ📌", url="https://t.me/MrRnp")
            ]]
                ...
                photo="https://telegra.ph/file/b5b5bdea4903889bedcf5.jpg",
