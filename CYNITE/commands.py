...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [[
                    ...
                    InlineKeyboardButton('ᴜᴘᴅᴀᴛᴇs', url='https://t.me/RnpUpdate'),
                    InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ', url='https://t.me/MrRnp')
                  ]]
    ...
    if len(message.command) != 2:
        buttons = [[
                    ...
                    InlineKeyboardButton('sᴜʙsᴄʀɪʙᴇ ᴏᴜʀ ʏᴛ ᴄʜᴀɴɴᴇʟ', url="https://www.youtube.com/@RnpDeveloper")
                  ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        await client.send_photo(
            photo="https://telegra.ph/file/fe821c29927c7304fbafa.jpg",
...
async def ping(_, message):
    kd = await message.reply_sticker('https://telegra.ph/file/fe821c29927c7304fbafa.jpg')
