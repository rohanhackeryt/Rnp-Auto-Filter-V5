...
PICS = (environ.get('PICS', 'https://telegra.ph/file/b5b5bdea4903889bedcf5.jpg')).split()
NOR_IMG = environ.get("NOR_IMG", "https://telegra.ph/file/deeb6bae576c4ff19b489.jpg")
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/file/8ee413afc32e5b393e790.jpg")
NEWGRP = environ.get("NEWGRP", "https://telegra.ph/file/b5b5bdea4903889bedcf5.jpg")

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1225573229').split()]
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MrRnp')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/RnpUpdate')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/MrRnp')
...
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 't.me/RnpUpdate')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/How_To_Download_Moviezs/20')
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡️<b>File uploaded by [Rnp Media](https://t.me/RnpMedia)</b>⚡️\n\n🎦 <b>File Name: </b> ➥  <i><code>{file_name}</code></i> <code>RnpMedia mkv</code>\n⚙️ <b>Size: </b><i>{file_size}</i>\n\n                ❤️<b>WE LOVE YOU</b>❤️\n🔥  ↭ <b>Join Now [Rnp Media](https://t.me/RnpMedia)</b> ↭  🔥")
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'linkfly.me')
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '20599b1c5d8f0e8d78771b5f33497ffbf582db14')
